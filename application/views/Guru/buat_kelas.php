...
<div class="card shadow mb-4">
    <div class="card-body">
        <a href="<?php echo base_url('Guru/AbsenMurid/DataAbsen/'. $nama_kelas. '/'. $id_tahun); ?>" class="btn btn-primary btn-icon-split mb-3">
                                            <span class="icon text-white-50">
                                                <i class="fas fa-arrow-left"></i>
                                            </span>
                                            <span class="text">Kembali</span>
        </a>
    <form action="<?php echo site_url('Guru/AbsenMurid/buatKelas/'. $nama_kelas . '/'. $id_tahun); ?>" method="post" enctype="multipart/form-data">
