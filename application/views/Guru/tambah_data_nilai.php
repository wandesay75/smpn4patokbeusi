...
<form action="<?php echo base_url('Guru/Nilai/simpanDataNilai/'. $nis. '/'. $id_tahun)?>" method="post" enctype="multipart/form-data">
...
<a href="<?php echo base_url('Guru/Nilai/DataNilai/'. $nis. '/' . $id_tahun); ?>" class="btn btn-warning">
