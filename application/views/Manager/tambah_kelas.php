...
<div class="card shadow mb-4">
    ...
    <form action="<?php echo site_url('Manager/DataKelas/tambahKelas'); ?>" method="post" enctype="multipart/form-data">
        ...
        <tr> 
            <td>
              <div class="form-group">
                ...
                <input type="text" name="nama_kelas" id="nama_kelas" class="form-control" value="<?php echo set_value('nama_kelas'); ?>" placeholder="Masukkan Nama Kelas">
