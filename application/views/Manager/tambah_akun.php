...
<div class="card shadow mb-4">
    ...
    <form action="<?php echo site_url('Manager/DataAkun/tambahAkun'); ?>" method="post" enctype="multipart/form-data">
        <table id="table" width="70%">
          <tr>
            <td>
              <div class="form-group">
                <label for="nama_user" class="text-info">Nama <span class="text-info">:</span></label>
                <input type="text" name="nama_user" id="nama_user" class="form-control" value="<?php echo set_value('nama_user'); ?>" placeholder="Masukkan Nama Pengguna">
          ...
          <tr> 
            <td>
              <div class="form-group">
                ...
                <input type="email" name="email" id="email" class="form-control" value="<?php echo set_value('email'); ?>" placeholder="Masukkan Email Pengguna">
          ...
          <tr> 
            <td>
              <div class="form-group">
                <label for="foto" class="text-info">Foto Pengguna <span class="text-info">:</span></label>
          ...
          <tr>
            <td>
              <div class="form-group">
                ...
                <p class="h6 mt-2 text-danger pl-2">Note : apabila role yang ditandai berwarna <br> merah, maka fitur tersebut belum tersedia!
                </p>
              </div>
            </td>
          </tr>
