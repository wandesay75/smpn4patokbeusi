...
<div class="card shadow mb-4">
    ...
    <form action="<?php echo site_url('Manager/TahunAjaran/simpanTahunAjaran'); ?>" method="post" enctype="multipart/form-data">

        <div class="form-group">
            <label for="tahun_ajaran" class="text-info">Tahun Ajaran</label>
            <input type="text" name="tahun_ajaran" placeholder="Masukkan Tahun Ajaran, contoh: 2023/2024" class="form-control">
