...
class AbsenMurid extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('Guru/cari_data_kelas.php', $data);
	...
	public function Data()
	{
		...
		$this->load->view('Guru/sidebar.php', $data);
		$this->load->view('Guru/topbar.php', $data);
		$this->load->view('Guru/absen_murid.php', $dataMurid);
		$this->load->view('Guru/footer.php', $data);
	}
	...
	public function buatKelas($kelas, $tahun_ajaran)
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('Guru/sidebar.php', $data);
			$this->load->view('Guru/topbar.php', $data);
			$this->load->view('Guru/buat_kelas.php', $data);
			$this->load->view('Guru/footer.php', $data);
		} else {
		...
		<div class="alert alert-success alert-dismissible">
			...
			redirect('Guru/AbsenMurid/submitAbsen/'. $kelas. '/'. $tahun_ajaran. '/'. $id_absen);
...
public function Submit($kelas, $tahun_ajaran, $id_absen)
{
	...
	public function submitAbsen($kelas, $tahun_ajaran, $id_absen)
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('Guru/sidebar.php', $data);
			$this->load->view('Guru/topbar.php', $data);
			$this->load->view('Guru/lihat_absen.php', $data);
			$this->load->view('Guru/footer.php', $data);
		} else {
			...
			redirect('Guru/AbsenMurid/DataAbsen/'. $kelas. '/'. $tahun_ajaran);
