...
class Nilai extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('Guru/data_nilai.php', $data);
    ...
    public function CariNilai()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('Guru/sidebar.php', $data);
            $this->load->view('Guru/topbar.php', $data);
            $this->load->view('Guru/lihat_nilai.php', $dataNilai);
            $this->load->view('Guru/footer.php', $data);
        }
    }
    ...
    public function tambahDataNilai($nis, $tahun_ajaran)
    {
        ...
        $this->load->view('Guru/sidebar.php', $data);
        $this->load->view('Guru/topbar.php', $data);
        $this->load->view('Guru/tambah_data_nilai.php', $data);
        $this->load->view('Guru/footer.php', $data);
    }
    ...
    public function simpanDataNilai($nis, $tahun_ajaran)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('Guru/Nilai/DataNilai/' . $nis . '/' . $id_tahun);
        }
    }
    ...
    public function update($id)
    {
        ...
        if ($row) {
            ...
            $this->load->view('Guru/sidebar.php', $data);
            $this->load->view('Guru/topbar.php', $data);
            $this->load->view('Guru/ubah_data_nilai.php', $data);
            $this->load->view('Guru/footer.php', $data);
        } else {
    ...
    {   
        ...
        $this->load->view('Guru/cetak_data_nilai.php', $dataNilai);
    }
}
